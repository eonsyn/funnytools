...
import DowryCases from '@/components/dowrypage/DowryCases';
import LawAndOrder from '@/components/dowrypage/LawAndOrder';
import UnderstandDowryPractice from "@/components/dowrypage/UnderstandDowryPractice"
export const metadata = {
  title: "AI Dowry Calculator | Dowry Ai",
  description:
    "Dowry Ai uses advanced AI to calculate dowry expectations, compare cases, and analyze social patterns. Try the Dowry Calculator now for free! 100% working dowry calculator",
  keywords: [
  ...
  return (
    <>
      ...
      <div className="py-10 px-1 text-center bg-white text-gray-700">
       Surprise! You can also check out what other people’s <strong>Dowry Ai Cards</strong> look like
        <Link
          href="/other-dowry"
          className="p-3 "
        >
      ...
      <div className="max-w-5xl px-2 mx-auto text-center mb-10">
        <h1 className="text-4xl font-extrabold text-pink-700 mb-4">
          How <strong>Dowry AI Calculator</strong> Works
        </h1>
      ...
      {/* Cards Grid */}
      <div className="max-w-6xl  bg-gradient-to-t  mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-6">
        {/* Card 1 */}
        <div className="md:bg-white/60 rounded-xl md:shadow-md p-6 flex flex-col justify-between md:border md:border-pink-200 hover:shadow-xl transition">
        ...
        {/* Card 2 */}
        <div className="md:bg-white/60 rounded-xl md:shadow-md p-6 flex flex-col   md:border md:border-pink-200 hover:shadow-xl transition">
          <h1 className="text-xl font-bold text-pink-600 mb-2"> Step 2: AI Generates Result</h1>
          <p className="text-sm text-gray-700">
            Once submitted, our <strong>Dowry AI Calculator</strong> crafts a humorous response mocking the outdated <strong>dowry system India</strong> still jokes about.
          </p>
